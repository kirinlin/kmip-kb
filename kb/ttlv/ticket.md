...
[Login](../operations/login.md) · [Logout](../operations/logout.md) · [Delegated Login](../operations/delegated-login.md) · [Authentication](authentication.md) · [Message Structure](message-structure.md)
