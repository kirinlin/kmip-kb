...
See [Key State and Times](../lifecycle/key-state-and-times.md) and [Unique Identifiers](../identification/unique-identifiers.md) for the attributes most at risk during consistency failures.
