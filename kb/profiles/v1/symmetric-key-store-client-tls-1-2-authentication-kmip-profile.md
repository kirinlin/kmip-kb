...
The Symmetric Key Store Client TLS 1.2 Authentication KMIP Profile is the TLS 1.2 variant of the [Basic Symmetric Key Store Client KMIP Profile](basic-symmetric-key-store-client-kmip-profile.md). It provides Register and Get on AES Symmetric Key objects, with the [TLS 1.2 Authentication Suite](../authentication/tls-1-2-authentication-suite.md) mandated for transport.
