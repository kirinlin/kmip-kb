...
See [Using Notify and Put Operations](using-notify-and-put-operations.md) for the server-to-client push mechanism that benefits constrained-device deployments.
