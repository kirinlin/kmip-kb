...
See [Key Shredding](key-shredding.md) for physical key destruction methods, and [Using Notify and Put Operations](../messaging/using-notify-and-put-operations.md) for the push notification mechanism.
