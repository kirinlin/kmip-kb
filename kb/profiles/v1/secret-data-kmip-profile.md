...
This profile uses the [Basic Authentication Suite](../authentication/basic-authentication-suite.md). For the TLS 1.2 variant of the same capability, see [Secret Data TLS 1.2 Authentication KMIP Profile](secret-data-tls-1-2-authentication-kmip-profile.md).
