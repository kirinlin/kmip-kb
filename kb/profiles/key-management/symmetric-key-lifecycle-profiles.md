...
A Symmetric Key Lifecycle Client extends the [Baseline Client](../base-encoding/base-profiles.md) with the ability to request symmetric key operations from the server. No additional operations are mandatory on the client side beyond the Baseline — the client may invoke any operation the server supports and may choose which of the lifecycle steps to drive.

## Server

A Symmetric Key Lifecycle Server extends the [Baseline Server](../base-encoding/base-profiles.md) and adds:
