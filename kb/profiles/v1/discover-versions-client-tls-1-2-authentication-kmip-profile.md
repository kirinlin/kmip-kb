...
The Discover Versions Client TLS 1.2 Authentication KMIP Profile is the TLS 1.2 variant of the [Basic Discover Versions Client KMIP Profile](basic-discover-versions-client-kmip-profile.md). The capability is identical — invoking Discover Versions for session-startup version negotiation — but the channel uses the [TLS 1.2 Authentication Suite](../authentication/tls-1-2-authentication-suite.md).
