...
See [Batched Requests and Responses](../messaging/batched-requests-and-responses.md) and [Reducing Multiple Requests Through the Use of Batch](../messaging/reducing-multiple-requests-through-the-use-of-batch.md).
