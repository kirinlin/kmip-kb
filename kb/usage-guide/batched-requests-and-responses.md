...
See [ID Placeholder](id-placeholder.md) for cross-item reference details, [Reducing Multiple Requests Through the Use of Batch](reducing-multiple-requests-through-the-use-of-batch.md), and [Maximum Message Size](maximum-message-size.md).
