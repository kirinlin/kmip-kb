...
See [ID Placeholder](../identification/id-placeholder.md) for the mechanism that carries object identity across batch items, and [Batched Requests and Responses](../messaging/batched-requests-and-responses.md) for how multi-step operations are structured.
