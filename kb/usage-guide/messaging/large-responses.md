...
See [Maximum Message Size](maximum-message-size.md) for batch-specific considerations, and [Handling Large Locate Result Sets](../identification/handling-large-locate-result-sets.md) for the pagination pattern.
