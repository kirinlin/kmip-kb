...
A PKCS#11 Client extends the [Baseline Client](base-profiles.md) and conforms to the PKCS#11 Encoding specification.

## Server

A PKCS#11 Server extends the [Baseline Server](base-profiles.md) and conforms to the PKCS#11 Encoding specification.
