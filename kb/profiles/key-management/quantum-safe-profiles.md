...
A Quantum Safe Client extends the [Baseline Client](../base-encoding/base-profiles.md) and must support TLS v1.3. It may claim any other spec clauses that do not conflict with the profile.

## Quantum Safe Server (§5.16)

A Quantum Safe Server extends the [Baseline Server](../base-encoding/base-profiles.md) and adds:
