...
§12.2 makes client conformance a property of the profiles document: a client
conforms to KMIP 1.4 by meeting at least one client profile in [KMIP-Prof],
and claiming a profile commits the client to every normative statement in
that profile's clauses and subclauses.
