...
See [Certify and Re-certify](certify-and-re-certify.md) and [Using Offset in Re-key and Re-certify Operations](../lifecycle/using-offset-in-re-key-and-re-certify-operations.md).
