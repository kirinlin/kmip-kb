...
See [Batched Requests and Responses](../messaging/batched-requests-and-responses.md) and [ID Placeholder](id-placeholder.md) for the mechanisms that make multi-object retrieval efficient.
