...
The Asymmetric Key Store Server TLS 1.2 Authentication KMIP Profile is the TLS 1.2 variant of the [Basic Asymmetric Key Store Server KMIP Profile](basic-asymmetric-key-store-server-kmip-profile.md). It stores client-provided RSA key pairs (Register on Public Key and Private Key objects) with the [TLS 1.2 Authentication Suite](../authentication/tls-1-2-authentication-suite.md) mandated for transport.
