...
The Basic Secret Data Client KMIP Profile defines client requirements for managing Secret Data objects in KMIP v1.1, using the [Basic Authentication Suite](../authentication/basic-authentication-suite.md). A client claiming this profile can store, retrieve, and manage opaque secret material — passwords, tokens, PINs, pre-shared keys — at a server that claims the [Basic Secret Data Server KMIP Profile](basic-secret-data-server-kmip-profile.md).
