...
See [Private Key](../../objects/private-key.md), [Public Key](../../objects/public-key.md), and [Authentication](../identity/authentication.md) for the underlying object types and authentication context.
