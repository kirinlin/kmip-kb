...
An Opaque Managed Object Store Client extends the [Baseline Client](../base-encoding/base-profiles.md). No mandatory operations are added beyond the Baseline; the client may use Register to store objects and Get/Locate to retrieve them.

## Server

An Opaque Managed Object Store Server extends the [Baseline Server](../base-encoding/base-profiles.md) and adds:
