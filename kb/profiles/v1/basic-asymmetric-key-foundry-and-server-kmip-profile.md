...
- Create Key Pair must support at least the key sizes required by the [Asymmetric Key Lifecycle Profiles](../key-management/asymmetric-key-lifecycle-profiles.md) (RSA-2048 minimum; RSA-3072 or RSA-4096 recommended for new keys).
